...
#'
#' \code{check_meteo_3DFEM} perform some basic tests on the variables in the
...
#'   file. If TRUE, the meteo file is saved with the same name and the same directory of
...
#'   \code{plot=TRUE}
#'
#' @details The function checks for consistency with the columns' name convention
#'   of the model, for NA, missing data, missing observation in the weather time
#'   series, anomalous values, and temperature relationships (i.e.,
